...
(function ($) {
                ...
                */
                validate: function (dw, i) {
                    ...
                    var temp = inst.temp, //.slice(0),
                        mins = { y: mind.getFullYear(), m: 0, d: 0, h: 0, i: 0, s: 0, a: 0 },
                        maxs = { y: maxd.getFullYear(), m: 11, d: 31, h: 10, i: 9, s: 9, a: 1 },
                        minprop = true,
                        maxprop = true;
                    $.each(['y', 'm', 'd', 'a', 'h', 'i', 's'], function (x, i) {
                        if (o[i] !== undefined) {
                            ...
                            if (i == 'd') {
                                y = get(temp, 'y');
                                m = get(temp, 'm');
                                maxdays = 32 - new Date(y, m, 10).getDate();
                                max = maxdays;
                                if (regen) {
    ...
    */
    ms.parseDate = function (format, value, settings) {
        var def = new Date("2015-04-03 03:03");
